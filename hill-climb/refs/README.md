...
- `bison-breakaway-*.png` — optional feel-only stills for [BrenBuilds](https://x.com/BrenBuilds/status/2097221820743139824) when attached on the operator box. Pattern only for `experiments/ochre-gallop`: three environments + a chase. Do **not** scrape their live, copy park names, NPS marks, mode titles, or assets. If missing, invent from the public pitch.
