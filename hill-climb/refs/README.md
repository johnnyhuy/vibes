...
- `tushar-wind-wanders.jpg` — [TusharXo](https://x.com/TusharXo/status/2096741535891251261) live still (high-angle knoll, turquoise water, islands). Built: `experiments/zephyr-vale/`. Notes: `docs/reverse-engineering/zephyr-vale.md`. Feel / lighting / composition only. Do not copy their map, HUD, Crayon chrome, or play bundle.
