...
| <img src="docs/previews/fairday-walk.png" width="280" alt="Fairday Walk laundry court on a breezy lane (still)"> | [fairday-walk](./experiments/fairday-walk/README.md) | — | Fairday Walk. Breezy residential memory walk, scroll stops, Explore orbit. Local-only. React + R3F + drei. |
