...
- **Asset**: [Kloofendal 48d Partly Cloudy (pure sky)](https://polyhaven.com/a/kloofendal_48d_partly_cloudy_puresky)
- **Author**: Greg Zaal
- **Licence**: [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/)
- **File**: `public/hdri/fairday-sky.hdr` (1k)

Loaded under Suspense as a local drei `<Environment>`. No runtime CDN.

## Geometry

Lane houses, tiled roofs, laundry cloth, bicycles, well, coop, pigeons, awning, ferns, fig, and rain barrel are original procedural work under the repo MIT licence. Canvas plaster / cobble / tile / wood maps are generated at runtime. No Kenney hero. No third-party GLB.
