export const BRAND = {
  ...
  place: 'Fairday Walk',
  placeLabel: 'A neighbourhood journal',
  slip: 'Slip 7',
} as const;
...
export const STOPS: Stop[] = [
  stop({
    ...
    name: 'Laundry Court',
    kicker: '01 · court',
    caption: 'Sheets catch the breeze above a shared courtyard.',
    position: [0, 0, 0],
    yaw: 1.24,
    distance: 15.4,
    height: 5.65,
  ...
  stop({
    ...
    name: 'Bicycle Shed',
    kicker: '02 · lean-to',
    caption: 'Two bicycles rest beneath a corrugated lean-to.',
    position: [0.4, 0, -22],
    yaw: 0.62,
    distance: 10.2,
    height: 2.85,
  ...
  stop({
    ...
    name: 'Courtyard Well',
    kicker: '03 · ring',
    caption: 'A stone well, a bucket, and a rim of moss.',
    position: [-0.6, 0, -44],
    yaw: 0.38,
    distance: 9.4,
    height: 2.55,
  ...
  stop({
    ...
    name: 'Shop Awning',
    kicker: '04 · stripe',
    caption: 'Striped canvas shades a small market stall.',
    position: [0.8, 0, -66],
    yaw: 0.72,
    distance: 10.6,
    height: 2.9,
  ...
  stop({
    ...
    name: 'Window Fern',
    kicker: '05 · sill',
    caption: 'Plants spill from a recessed balcony.',
    position: [-0.4, 0, -88],
    yaw: 0.18,
    distance: 8.6,
    height: 3.55,
  ...
  stop({
    ...
    name: 'Rooftop Pigeon',
    kicker: '06 · loft',
    caption: 'Three birds perch above a tiled roof.',
    position: [0.2, 0, -110],
    yaw: 0.92,
    distance: 9.4,
    height: 8.2,
  ...
  stop({
    ...
    kicker: '07 · amber',
    caption: 'Warm afternoon light gathers between two gables.',
    position: [0.6, 0, -132],
    yaw: 0.44,
    distance: 10.8,
    height: 3.05,
  ...
  stop({
    ...
    name: 'Fig Alley',
    kicker: '08 · barrel',
    caption: 'A fig tree and rain barrel mark the bend in the lane.',
    position: [0.4, 0, -154],
    yaw: 0.34,
    distance: 8.6,
    height: 2.45,
