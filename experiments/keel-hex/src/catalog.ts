...
export const BRAND = {
  ...
  name: 'Keel Hex',
  nameLabel: 'Assembly study',
  chassis: 'KH-55',
  chassisName: 'Spool Plate',
  chassisLabel: 'Spool Plate',
  bench: 'Spool Bay',
  benchLabel: 'Spool Bay',
  chip: 'Invented trainer · hex bench',
  title: 'Inside the KH-55.',
  lede: 'Explore a six-rotor trainer. Lift the cover, separate the components, or follow its assembly step by step.',
  cta: 'Play assembly',
  ctaStop: 'Pause assembly',
...
export const MODES: ModeInfo[] = [
  ...
  },
  {
    ...
    index: '03',
    name: 'Exploded',
    copy: 'Separate the components with the distance slider. Orbit to inspect their connections.',
  },
];
