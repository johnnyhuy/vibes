...
All trainer geometry, HUD copy, and instruction marks are original procedural work under the repo MIT licence. No third-party GLB. No PX4 / S3 / OEM catalog.

Local studio HDRI (CC0):

- `public/hdri/studio-small.hdr` — [Studio Small 03](https://polyhaven.com/a/studio_small_03), Sergej Majboroda / Poly Haven, CC0

## Related kitchen-sink credits

Sibling experiments that *do* ship licensed meshes keep their own `ATTRIBUTION.md`. This folder does not reuse those files. Explode-assembly remains the Tesla Model 3 *product explode*; this pass is a step-sequenced trainer bench.
