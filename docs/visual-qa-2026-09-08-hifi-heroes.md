...
- **Amber Longeron** — same Sopwith Camel mesh; MeshPhysical clearcoat + local studio HDRI so it stops reading as a flat toy.
- **Lumen Cuff** — same Spacebar headphones; studio HDRI + MeshPhysical clearcoat instead of Lightformer-only cubemap.
