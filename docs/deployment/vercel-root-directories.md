...
5. Only then ballance / courtyard / amber-longeron / nacre-loom / heartwood-warden / moon-dumpling-relay / foil-tilt-card / zephyr-vale / cinder-mere. Do **not** create `vibes-ballance-roll`, a courtyard project, `vibes-amber-longeron`, `vibes-nacre-loom`, `vibes-heartwood-warden`, `vibes-moon-dumpling-relay`, `vibes-foil-tilt-card`, `vibes-zephyr-vale`, or `vibes-cinder-mere` until quota is healthy. New projects follow `vibes-<experiment>`.
...
**Author**: Johnny Huynh  
**Last updated**: 2026-09-08 (cinder-mere)
