...
5. Only then ballance / courtyard / amber-longeron / nacre-loom / heartwood-warden / moon-dumpling-relay / foil-tilt-card / zephyr-vale / cinder-mere / kiln-studs / alba-forum / brine-causeway. Do **not** create `vibes-ballance-roll`, a courtyard project, `vibes-amber-longeron`, `vibes-nacre-loom`, `vibes-heartwood-warden`, `vibes-moon-dumpling-relay`, `vibes-foil-tilt-card`, `vibes-zephyr-vale`, or `vibes-brine-causeway` until quota is healthy. `vibes-cinder-mere`, `vibes-kiln-studs`, and `vibes-alba-forum` already exist as link-only — do not promote them until quota recovers. New projects follow `vibes-<experiment>`.
...
**Author**: Johnny Huynh  
**Last updated**: 2026-09-08 (brine-causeway)
