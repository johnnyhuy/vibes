...
- [mrblackstudio](https://x.com/mrblackstudio/status/2096893411395600782) — headphones built in Blender via MCP (stylised over-ear, glass cup, orange grille)
...
- Earlier parking note: [audio-gadget-product-spin.md](./audio-gadget-product-spin.md)

**Study date**: 2026-09-08  
**Status**: **Built** — `experiments/audio-gadget-spin/` (Lumen Cuff). Clean-room only.
...
The public copy is: Claude Opus + Three.js + Claude Code can now produce most of an **audio-gadget marketing site**. The old job (studio model + WebGL engineer) collapses into a prompt → orbiting hero.

The 576×1024 amplify thumb I pulled earlier is a **loft / architecture scroll** (“SCROLL TO EXPLORE”, misty house). I still do not treat that frame as a headphone spec. The *text* is the brief: dark studio, product on a turntable, frosted marketing chrome.
